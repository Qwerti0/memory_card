...
from main import question   # 🔴 ВАЖЛИВО: імпортуємо question
...
layout_card.addWidget(question_label, alignment=Qt.AlignCenter)
...
def check_answer():
    if answer_btn.text() == "Відповідь":
        ...
        if selected is None:
            lb_Result.setText("⚠️ Оберіть відповідь!")
            return
        ...
        show_question(choice(question))  # 🔴 використовуємо question
